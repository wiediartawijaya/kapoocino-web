					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('admin/home')?>">iklan</a>
							</li>
						...
						<div class="page-header">
							<div class="row">
								...
								<div class="col-md-1 col-md-offset-8">
									<?php 
										echo form_open("admin/iklan");
										echo form_submit("tambah" , "tambah",array(
										"id" => "tambah",
...
<div class=content>
									...
									<tbody>
									<?php
									$data['jenis_iklan']= $this->model_admin->getall_JenisIklan();
									foreach($data['jenis_iklan'] as $i)
									{
										echo "<tr>";
										echo "<td>" .$i->Id_Jenis_Iklan."</td>";
										echo "<td>" .$i->Nama_Jenis_Iklan."</td>";
										echo "<td>";
										echo form_submit("U".$i->Id_Jenis_Iklan , "Ubah",array(
											"id" => "U".$i->Id_Jenis_Iklan,
											"class" => "btn btn-warning btn-block",
											"style" => "margin:0 auto;padding:0;width:5em;height:2.5em;border-radius: 5px;"
											));
										echo form_submit("H".$i->Id_Jenis_Iklan , "Hapus",array(
											"id" => "H".$i->Id_Jenis_Iklan,
											"class" => "btn btn-danger btn-block",
											"style" => "margin:0 auto;padding:0;width:5em;height:2.5em;border-radius: 5px;"
											));
										echo "</td>";
