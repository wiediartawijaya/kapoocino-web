					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('admin/datauser')?>">Data user</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class=content>
									<table cellpadding=0 cellspacing=0 width=100% class="table table-bordered table-striped" id="table">
									<thead>
									<tr>
										<th>Nama User</th>
										<th>Alamat</th>
									...
									<tbody>
									<?php
									$data['user']= $this->model_admin->getall_client();
									foreach($data['user'] as $i)
									{
										echo "<tr>";
										//echo "<td>" .$i->Nama_user."</td>";
										//echo "<td>" .$i->Alamat."</td>";
										//echo "<td>" .$i->Telphone."</td>";
										$data['d_user']= $this->model_admin->getd_User($i->Kode_User);
										//print_r($this->model_admin->getall_user($i->Kode_User));
										foreach($this->model_admin->getdata_d_User($i->Kode_User) as $j)
										{
											echo "<td>" .$j->Nama_user."</td>";
											echo "<td>" .$j->Alamat."</td>";
											echo "<td>" .$j->Telphone."</td>";
										}
										echo "<td>" .$i->Email."</td>";
										echo "<td>" .$i->Jabatan."</td>";
										echo "<td>";
										echo form_submit("U".$i->Kode_User , "Ubah",array(
											"id" => "U".$i->Kode_User,
											"class" => "btn btn-warning btn-block",
											"style" => "margin:0 auto;padding:0;width:5em;height:2.5em;border-radius: 5px;"
											));
										echo form_submit("H".$i->Kode_User , "Hapus",array(
											"id" => "H".$i->Kode_User,
