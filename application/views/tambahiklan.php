						...
						<div class="page-header">
							<div class="row">
								...
								<div class="col-md-1 col-md-offset-8">
									<?php 
										echo form_open("admin/tambahiklan");
							...
							<div class="col-xs-12">
								...
								<div class=content>
									<div class="input-group">
										...
										<?php echo form_input("nama_jenis_iklan","",array(
											"id" => "nama_jenis_iklan",
											"placeholder" => "Masukan nama jenis iklan",
									...
									<div class="input-group" style="margin-top:1em">
										...
										<?php echo form_submit("tambahkan" , "tambahkan",array(
										"id" => "tambah",
										"class" => "btn btn-danger btn-block",
										"style" => "margin:0 auto;padding:0;width:7em;height:2.5em;border-radius: 5px;"
										)); ?>
									</div>
								</div>
									<?php echo form_close();?>
