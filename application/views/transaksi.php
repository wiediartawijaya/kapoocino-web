					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?php echo site_url('admin/home')?>">transaksi</a>
							</li>
										...
										<tbody>
											...
											<?php 
												...
												{	
													echo "<tr>";
														echo "<td>".$tmp."</td>";
														$this->session->set_userdata('id_trans_new',$i->id_trans);
														$this->model_admin->getjenis_iklan($i->Id_jenis_iklan);
														foreach ($this->model_admin->getjenis_iklan($i->Id_jenis_iklan) as $k){
															echo "<td>".$k->Nama_Jenis_Iklan."</td>";
														}
														echo "<td>".$i->Tipe_iklan."</td>";
														echo "<td>".$i->Isi_iklan."</td>";
														echo "<td>".$i->tanggal_mulai."</td>";
														echo "<td>".$i->tanggal_berakhir."</td>";
														echo "<td>".$i->durasi."</td>";
														echo "<td>".$i->harga."</td>";
														if($i->notification == 0)
														{
															echo "<td>";
															echo form_submit("S".$i->id_trans , "belum di setujui",array(
																"id" => $i->id_trans,
																"class" => "button expanded",
																"style" =>"border-radius:5px;padding:0 auto;margin:0 auto;background:rgb(0, 140, 186);color:white;"
																));
															echo "</td>";
														}
														else if($i->notification == 1)
														{
															echo "<td>";
															echo form_submit("S".$i->id_trans , "setujui",array(
																"id" => $i->id_trans,
																"class" => "button expanded",
																"style" =>"border-radius:5px;padding:0 auto;margin:0 auto;background:rgb(0, 140, 186);color:white;"
																));
